            ...
            <form id='formFight' action="index.php" method="post">
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input required type="number" class="form-control <?php echo isset($formErrors["player"]["sante"]) ? "is-invalid" : "" ?>" name="player[sante]" value="<?php echo $_POST["player"]["sante"] ?? "100" ?>">
                        </div>
                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label class="form-label">Santé</label>
                            <input required type="number" class="form-control <?php echo isset($formErrors["adversaire"]["sante"]) ? "is-invalid" : "" ?>" name="adversaire[sante]" value="<?php echo $_POST["adversaire"]["sante"] ?? "100" ?>">
                        </div>
